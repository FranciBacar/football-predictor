      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: '20px', marginBottom: 16, border: '1px solid #f0f0f0' }}>
          ...
          <p style={{ fontSize: 13.5, color: '#6b7280', margin: '0 0 14px', lineHeight: 1.5 }}>
            Napoveduješ točne rezultate posameznih tekem <strong>po 90 minutah</strong> (brez podaljškov in kazenskih strelov).
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { emoji: '🎯', pts: '3 točke', title: 'Točen rezultat', desc: 'Napoveš 2:1 in tekma se konča z 2:1.' },
              { emoji: '📐', pts: '2 točki', title: 'Pravilen tip + zadetki ene ekipe', desc: 'Napoveš 3:1, tekma se konča z 2:1 — zmaga je pravilna in away gol (1) se ujema.' },
              { emoji: '✅', pts: '1 točka', title: 'Pravilen tip tekme', desc: 'Pravilno napoveš zmagovalca ali neodločen izid, ampak zadetki ne ustrezajo.' },
              { emoji: '❌', pts: '0 točk', title: 'Napačen tip', desc: 'Napoveš zmago, pa je remi ali obratno.' },
            ].map(row => (
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: '20px', marginBottom: 16, border: '1px solid #f0f0f0' }}>
          ...
          <p style={{ fontSize: 13.5, color: '#6b7280', margin: 0, lineHeight: 1.6 }}>
            ...
            Pravilen napredovalec ti prinese <strong>+2 bonus točki</strong> (podvojeno).
          </p>
        </div>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: '20px', marginBottom: 16, border: '1px solid #f0f0f0' }}>
          ...
          <p style={{ fontSize: 13.5, color: '#6b7280', margin: '0 0 14px', lineHeight: 1.5 }}>
            Pred začetkom SP (zaklepanje: <strong>11. junija ob 20:00</strong>) napoveš:
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              ...
              { emoji: '🥇', title: 'Zmagovalec vsake skupine (A–L)', pts: '+3 točke vsaka' },
            ].map(row => (
              <div key={row.title} style={{
                ...
                <span style={{ fontWeight: 800, fontSize: 14, color: '#0f766e' }}>{row.pts}</span>
              </div>
            ))}
          </div>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: '20px', marginBottom: 16, border: '1px solid #f0f0f0' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div style={{ padding: '10px 14px', borderRadius: 10, background: '#f9fafb', fontSize: 13.5, color: '#374151', lineHeight: 1.5 }}>
              <strong>Napovedi tekem</strong> se zaklenejo <strong>15 minut pred začetkom</strong> vsake tekme. Po zaklenitvi spremembe niso možne.
            </div>
            <div style={{ padding: '10px 14px', borderRadius: 10, background: '#f9fafb', fontSize: 13.5, color: '#374151', lineHeight: 1.5 }}>
              <strong>Posebne napovedi</strong> (zmagovalec SP, strelec itd.) se zaklenejo <strong>11. junija ob 20:00</strong> — 30 minut pred prvo tekmo.
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: '20px', marginBottom: 16, border: '1px solid #f0f0f0' }}>
          ...
          <p style={{ fontSize: 13.5, color: '#6b7280', margin: 0, lineHeight: 1.6 }}>
            Ustvari zasebno skupino ali se pridruži obstoječi z invite linkom. Vsaka skupina ima svojo lestvico.
            Napovedi so skupne — ista napoved velja za vse tvoje skupine.
            Maksimalno <strong>50 članov</strong> na skupino.
          </p>
        </div>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: '20px', marginBottom: 24, border: '1px solid #f0f0f0' }}>
          <h2 style={{ fontSize: 16, fontWeight: 700, margin: '0 0 12px', color: '#1a1a1a' }}>
            🏅 Izenačeno število točk
          </h2>
          <p style={{ fontSize: 13.5, color: '#6b7280', margin: 0, lineHeight: 1.6 }}>
            Pri enakem številu točk odloča <strong>število točnih rezultatov</strong> (napovedi z 3 točkami). Kdor jih ima več, je višje na lestvici.
          </p>
        </div>
